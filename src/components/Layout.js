							...
							<Grid item key={data.id} xs={12} md={4}>
								<Card className={classes.card}>
									<CardMedia
										...
										image={ ( data.url.substring(data.url.lastIndexOf('.') + 1).includes("png") || data.url.substring(data.url.lastIndexOf('.') + 1).includes("jpeg") ) ? "https://webhostingmedia.net/wp-content/uploads/2018/01/http-error-404-not-found.png"  }
										title="Image title"
									/>
